...
export default function InternationalOnline() {
  ...
  const scriptURL = "https://script.google.com/macros/s/AKfycbwgyRQe0M2yifqPcghdetuhPblOvcunkwWTG3mn-VBc6b-E9Oi3QtCFIxNadgCWuUrk/exec";
      ...
      <section className="registration-section">
        <div className="container">
          <div className="content">
            ...
            <br />
            <h4>
              HELLO AISEEF 2026 INTERNATIONAL CITIZEN, Please consider the following
              ...
              <div className="user-details">
                ...
                <div className="input-box">
                  ...
                  >
                    ...
                    <option value="Asean Innovative Science Environmental and Entrepreneur Fair - Online Competition">
                      Online Competition
                    </option>
                    <option value="Asean Innovative Science Environmental and Entrepreneur Fair - Online Competition + Certificate and Medal (SOUTH EAST ASIA ONLY)">
                      Online Competition + Certificate and Medal (SOUTH EAST
                      ASIA)
                    </option>
                    <option value="Asean Innovative Science Environmental and Entrepreneur Fair - Online Competition + Certificate and Medal (Exclude SOUTH EAST ASIA)">
              ...
              <div className="user-details">
                ...
                <div className="input-box">
                  <label for="INFORMATION_RESOURCES" className="form-label">
                    AISEEF 2026 Competition Information Resources
                  </label>
                  <select
                    type="text"
