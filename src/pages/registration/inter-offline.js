...
export default function InternationalOffline() {
  ...
  const handleCategoryChange = (e) => {
    ...
    switch (value) {
      case "Asean Innovative Science Environmental and Entrepreneur Fair - Offline Competition":
        break;
      case "Asean Innovative Science Environmental and Entrepreneur Fair - Offline Competition + Full Package":
        break;
  ...
  const scriptURL = "https://script.google.com/macros/s/AKfycbw_NyoDwBSqomFWgiz8x6aEo2P-ZntQQJG0kFNrWTLQM-Y-4iLqyDsFvry1va1IeWTx/exec";
              ...
              <div className="user-details">
                ...
                <div className="input-box">
                  ...
                  >
                    ...
                    <option value="Asean Innovative Science Environmental and Entrepreneur Fair - Offline Competition + Full Package">
